...
const ProfileHeader = () => {
  ...
  const currentAccount = "0xOINKfsdfsafdO9KIOMJewfrrweBGV45t45XSE3D";
    ...
    <div className={style.wrapper}>
      <div className={style.header}>
        ...
        <div className={style.details}>
          <div className={style.primary}>Happy</div>
          <div className={style.secondary}>4 tweets</div>
        </div>
      </div>
      <div className={style.coverPhotoContainer}>
        <img
          src="https://wallpapers.net/neon-sunset-mountains/download/1500x500.jpg"
          alt="cover"
